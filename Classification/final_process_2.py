...
path_meituan = '../Related_Files/MeiTuan.csv'
path_class = '../Related_Files/class_.csv' # 类别
path_stop = '../Related_Files/stopWords_3.txt' # 停用词


path_neg = '../Related_Files/neg_newMeiTuan.txt'
path_posi = '../Related_Files/posi_newMeiTuan.txt'
